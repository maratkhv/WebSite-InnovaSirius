...
import shape from '../assets/svg/Union.svg'; // Твоя SVG рамка
...
const slides = [
  {
    text: "Компания InnovaSirius — резидент Технопарка Высоких Технологий Югры.",
    img: img1
  },
  {
    text: "Вошли в топ 50 перспективных проектов. Наш проект занял 29 место в топе 50 перспективных проектов в России по версии ПУТП 2025 года.",
    img: img2
  },
  {
    text: "Устройство прошло тестирование и стабильно обеспечивает мониторинг  среды в пространстве “Башня Политех”.",
    img: img3
  },
  {
    text: "Компания InnovaSirius -- лауреат X Всероссийской конференции техников и изобретателей в Государственной Думе Российской Федерации.",
    img: img4
  }
];
    ...
    <section className="achiev">
      ...
      <div className="achiev__carousel-wrapper">
       <div className="achiev__image-layer">
        <img src={slides[currentIndex].img} className="achiev__main-img" alt="" />
       </div>
       <img src={shape} className="achiev__shape" alt="frame" />
       <div className="achiev__top-layer">
        <div className="achiev__text-container">
          <p className="achiev__description">{slides[currentIndex].text}</p>
        </div>
